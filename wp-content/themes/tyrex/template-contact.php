	...
	<section id="content" role="main">
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<section class="entry-content">
				...
				<?php include(WP_CONTENT_DIR . '/plugins/sea-spider-tyrex/snippets/contact-page-info-box.php'); ?>
				<?php include(WP_CONTENT_DIR . '/plugins/sea-spider-tyrex/snippets/contact-page-map.php'); ?>
				<?php the_content(); ?>
