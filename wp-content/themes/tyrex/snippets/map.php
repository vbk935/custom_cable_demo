...
var latitude;
var longitude;
var color = "#eeeeee"; //Set your tint color. Needs to be a hex value.
...
function initGoogleMap() {
	...
	var infowindow = new google.maps.InfoWindow({
	      content: "<div class='iwContent'>"+address+"<br /><a href='https://goo.gl/maps/FJWmq'><i class='fa fa-map-marker'></i> Show on Google Maps</a></div>"
	});
