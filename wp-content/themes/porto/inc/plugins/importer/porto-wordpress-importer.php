...
if ( class_exists( 'WP_Importer' ) ) {
	class Porto_WP_Import extends WP_Importer {
		...
		function process_menu_item( $item ) {
			...
			if ( isset( $_menu_item_url ) && ( 'http://sw-themes.com/porto_dummy/portfolio' == $_menu_item_url || 'http://sw-themes.com/porto_dummy/portfolio/' == $_menu_item_url || 'http://sw-themes.com/porto_dummy/portfolios' == $_menu_item_url || 'http://sw-themes.com/porto_dummy/portfolios/' == $_menu_item_url || 'http://sw-themes.com/porto_dummy/member' == $_menu_item_url || 'http://sw-themes.com/porto_dummy/member/' == $_menu_item_url ) ) {
