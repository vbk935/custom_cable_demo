...
<?php endif; ?>
<?php if ( class_exists( 'Woocommerce' ) || ! in_array( 'vc_accordion', $unused_shortcode_list ) || ! in_array( 'vc_accordion_tab', $unused_shortcode_list ) ) : ?>
...
<?php endif; ?>
<?php if ( ! in_array( 'porto_one_page_category_products', $unused_shortcode_list ) ) : ?>
