...
function my_header_add_to_cart_fragment( $fragments ) {
    ...
    ?>
    <a class="wcmenucart-contents" href="<?php echo WC()->cart->get_cart_url(); ?>"><i class="fa fa-shopping-cart"></i> View Cart <span class="cart-contents-count">(<?php echo esc_html( $count ); ?>)</span>
  </a>
  <?php
...
function custom_search($menu, $args) {
  ...
  ob_start();
     ...
     $menu_item = '<form name="custom_search" id="custom_search" method="POST" action="http://localhost/CustomCable/search-results/">';
     $menu_item .= '<input type="text" name="search_text" id="search_text">';
     $menu_item .= '<input type="submit" name="search" value="Search" >';
     $menu_item .= '</form>';
