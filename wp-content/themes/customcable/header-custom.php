...
<body <?php body_class($code); ?>>
	...
	<div id="wrapper" class="hfeed">
		<header id="header" role="banner" class="header-custom">
				...
				<div class="container">
					...
					<?php if ( is_front_page() ) { echo '<h1>'; } ?>
					  <a class="navbar-brand" href="/" >
						...
						if( !empty($image) ): ?>
							<img src="<?php echo $image['url']; ?>" alt="Megladon Logo" class="logo-small img-responsive"/>
						<?php endif; ?>
						<?php  $image = get_field('logo_large', 'option');
						if( !empty($image) ): ?>
							<img src="<?php echo $image['url']; ?>" alt="Megladon Logo" class="logo-large"/>
						<?php endif; ?>			
			...
			<?php if( $show_sub_nav == 1){ ?>
				<div class="subnav">
						<nav id="menu2"  class="navbar navbar-default bghfd" role="navigation">
						  <div class="container">
