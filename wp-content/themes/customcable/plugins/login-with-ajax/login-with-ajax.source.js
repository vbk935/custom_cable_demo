		...
		if(data.result === true){	
			if( data.widget != null ){
				$.get( data.widget, function(widget_result) {
					...
					/**
					 * Hack after successful login
					 */
					 // Hide the login link at the top header
					$(document).find("#menu-main").find("li a:contains('Login')").hide();
					$(document).find("#menu-main").find("li a:contains('Log In')").hide();
					
					var htmlAfterLogin = "<div><p>Loggedin successfully. Resuming, please wait...</p>";
					form.parent('.lwa').html(htmlAfterLogin);
					setTimeout(function() {
