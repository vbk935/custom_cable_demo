<div class="ueditor-bar ueditable" id="{{cid}}">
	<div class="ueditor-bar-buttons">
		...
		{[ if(cancelButton){ ]}
		<a class="ueditor-action-cancel sidebar-commands-small-button ueditor-bar-icon" href="#">{{Upfront.Settings.l10n.global.content.cancel}}</a>
		{[ } ]}
		{[ if(draftButton){ ]}
		<a class="ueditor-action-draft sidebar-commands-small-button" href="#">{{Upfront.Settings.l10n.global.content.save_draft}}</a>
		{[ } ]}
		<a class="ueditor-action-publish sidebar-commands-small-button ueditor-bar-icon" href="#">{{buttonText}}</a>
	</div>
