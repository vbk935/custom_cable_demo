...
class Upfront_UsliderView extends Upfront_Object {
	...
	private static function _get_l10n ($key=false) {
		$l10n = array(
			...
			'above_img' => __('Caption above slide', 'upfront'),
			'below_img' => __('Caption below slide', 'upfront'),
			...
			'at_right' => __('Slide left, caption right', 'upfront'),
			'at_left' => __('Slider right, caption left', 'upfront'),
			'cap_position' => __('Slide caption layout', 'upfront'),
			'edit_img' => __('Crop current slide', 'upfront'),
			'remove_slide' => __('Remove slide', 'upfront'),
			'img_link' => __('Link current slide', 'upfront'),
			...
			'notxt' => __('No Caption', 'upfront'),
			'txtb' => __('Caption below', 'upfront'),
			'txto' => __('Caption over', 'upfront'),
			'txts' => __('Caption on side', 'upfront'),
			...
			'show_controls' => __('Show Controls', 'upfront'),
			...
			'txt_over_img' => __('Text over image', 'upfront'),
			'txt_below_img' => __('Text below image', 'upfront'),
			'txt_on_side' => __('Text on the side', 'upfront'),
			'txt_only' => __('Text / widget only', 'upfront'),
