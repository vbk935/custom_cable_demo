...
<section id="mp-order-history" class="mp_orders mp_orders-list">
	...
	</div><!-- end mp_order_detail --></div><!-- end mo_order --></div><!-- end mp_order_details -->
</section><!-- end mp-order-history --><p></p>
...
<p>
			...
			</div><!-- end mp_order_detail --></div><!-- end mp_order -->
				<div class="mp_order_cart">																			<div class="mp_cart_item" id="mp-cart-item-104">
				<div class="mp_cart_item_content mp_cart_item_content-thumb"><img src="<?php echo get_theme_root_uri() ?>/upfront/img/placeholder-image.png" width="75" height="75" style="max-height: 75px;">
						</div>
						...
						<div class="mp_cart_item_content mp_cart_item_content-price"><!-- MP Product Price -->
							<div class="mp_product_price" itemtype="http://schema.org/Offer" itemscope="" itemprop="offers">
									<span class="mp_product_price-normal" itemprop="price">$0.00</span>
							</div>
							<!-- end mp_product_price -->
						</div>
						<!-- end mp_cart_item_content -->
						<div class="mp_cart_item_content mp_cart_item_content-qty">2						</div>
						...
						<!-- end mp_cart_item_content -->
						<div class="mp_cart_item_content mp_cart_item_content-qty">4						</div>
						<!-- end mp_cart_item_content --></div><!-- end mp_cart_item -->
			...
			</section><!-- end mp-single-order-details --><p></p>