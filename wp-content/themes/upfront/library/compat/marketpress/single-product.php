<section id="mp-single-product-46" class="mp-single-product" itemscope="" itemtype="http://schema.org/Product">
	<div class="mp_product mp_single_product mp_single_product-has-image mp_single_product-image-alignleft">
		<div class="mp_single_product_images">
			<div class="lSSlideOuter ">
				<div class="lSSlideWrapper usingCss">
					<ul id="mp-product-gallery" class="mp_product_gallery lightSlider lsGrab lSSlide" style="width: 300px; height: 300px; padding-bottom: 0%;">
						<li class="lslide active" style="width: 300px; margin-right: 0px;">
						<img src="<?php echo get_theme_root_uri() ?>/upfront/img/placeholder-image.png">
						</li>
					</ul>
					<div class="lSAction">
						<a class="lSPrev"></a>
				...
				<ul class="lSPager lSGallery" style="margin-top: 5px; transition-duration: 400ms; width: 308.9px; transform: translate3d(0px, 0px, 0px);">
					<li style="width:97.8px;margin-right:5px; float: left" class="active">
						<a href="#">
						<img src="<?php echo get_theme_root_uri() ?>/upfront/img/placeholder-image.png">
						</a>
					</li>
					<li style="width:97.8px;margin-right:5px; float: left">
						<a href="#">
						<img src="<?php echo get_theme_root_uri() ?>/upfront/img/placeholder-image.png">
						</a>
					</li>
			...
			<!-- end mp_product_gallery -->
		</div>
		<!-- end mp_single_product_images -->
		<div class="mp_single_product_details">
			...
			<div class="mp_product_callout">
				<form id="mp-buy-product-46-form" class="mp_form mp_form-buy-product  " method="post" data-ajax-url="http://local.woo-compat.dev/wp-admin/admin-ajax.php?action=mp_update_cart" action="http://local.woo-compat.dev/store/cart/" novalidate="novalidate">
		...
		<div class="mp_single_product_extra">
			...
			<!-- end mp-product-overview -->
			<div id="mp-related-products-46" class="mp-multiple-products mp_product_tab_content mp_product_tab_content-related-products">
			...
			<!-- end mp-related-products -->
		</div>
		<!-- end mp_single_product_extra -->
	</div>
	<!-- end mp_product/mp_single_product -->
</section>