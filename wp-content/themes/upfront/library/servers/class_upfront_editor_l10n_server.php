	...
	private static function _get_l10n ($key=false) {
		$l10n = array(
			...
			'behaviors' => array(
				...
				'this_layout_only' => __('This LAYOUT_TYPE has some Layout Changes. Would you like to apply those changes to All LAYOUT_TYPE_PLURAL or just This LAYOUT_TYPE?', 'upfront'),
				'layout' => __('Layout', 'upfront'),
				'layouts_of_this_type' => __('Layouts of this type', 'upfront'),
			...
			'views' => array(
				...
				'post_delete_nag' => __('Are you sure you want to delete', 'upfront'),
				...
				'edit_global_bg' => __('Global BG', 'upfront'),
				'edit_global_regions' => __('Global Regions', 'upfront'),
				'add_custom_css_rules' => __('Edit Global CSS', 'upfront'),
				'theme_font_manager' => __('Manage Fonts', 'upfront'),
				...
				'padding_settings' => __('Adjust Padding', 'upfront'),
				...
				'bg_padding' => __('Padding', 'upfront'),
				'customize_padding' => __('Customize Padding', 'upfront'),
				...
				'create_or_choose_region' => __('Create a New Region or choose one of the Global Regions', 'upfront'),
				...
				'video_source' => __('Video Source', 'upfront'),
				'video_service' => __('Video Service', 'upfront'),
				'uploaded_video' => __('Uploaded Video', 'upfront'),
				'video_cropping_method' => __('Video Cropping Method', 'upfront'),
				...
				'keep_ratio' => __('Maintain ratio', 'upfront'),
				...
				'origin_position' => __('Origin Position', 'upfront'),
				'image_size' => __('Image Size', 'upfront'),
				'resize_image' => __('Resize image', 'upfront'),
				'resize_image_percent' => __('% of region width', 'upfront'),
				...
				'featured_default' => __('If feature image has not been set', 'upfront'),
				'featured_default_color' => __('Use this color', 'upfront'),
				'featured_default_image' => __('Use this image', 'upfront'),
				'featured_default_hide' => __('Hide this region', 'upfront'),
				'autorotate_each' => __('Auto-rotate', 'upfront'),
				'seconds' => __('seconds', 'upfront'),
				'always' => __('Always', 'upfront'),
				'show_ctrl' => __('Show Controls', 'upfront'),
				'controls_style' => __('Controls Type', 'upfront'),
				...
				'video_url' => __('Video URL (YouTube, Vimeo or Wistia)', 'upfront'),
				...
				'add_sub_region' => __('Sub Regions', 'upfront'),
				'advanced_settings' => __('Advanced Settings', 'upfront'),
				...
				'roles_info_label' => __('Click here to learn more', 'upfront'),
				'roles' => array(
					'none' => __('No role', 'upfront'),
					'banner' => __('Header', 'upfront'),
					'main' => __('Main content', 'upfront'),
					'complementary' => __('Sidebars', 'upfront'),
				...
				'em' => __('em', 'upfront'),
				'percent' => __('%', 'upfront'),
				'current_color' => __('Text color (Hex or RGBA)', 'upfront'),
