...
<div id="layer_settings">
	...
	<div class="form_collector layer_settings_collector" data-type="layersconfig" data-pcontainer="#layer_settings" data-offset="#rev_builder_wrapper">
		...
		<div id="gst_layer_collector" class="gso_wrap">
			<div id="gst_layer_1" data-select="#gst_layer_1" data-unselect=".layer_submodule_trigger" class="layer_submodule_trigger opensettingstrigger selected" data-collapse="true" data-forms='["#form_layer_content"]'><i class="material-icons">create</i><span class="gso_title"><?php _e('Content', 'revslider');?></span></div><!--
			--><div id="gst_layer_3" data-select="#gst_layer_3" data-unselect=".layer_submodule_trigger" data-evt="updateInputFields" class="callEvent layer_submodule_trigger opensettingstrigger" data-collapse="true" data-forms='["#form_layer_style"]'><i class="material-icons">palette</i><span class="gso_title"><?php _e('Style', 'revslider');?></span></div><!--
			--><div id="gst_layer_2" data-select="#gst_layer_2" data-unselect=".layer_submodule_trigger" class="layer_submodule_trigger opensettingstrigger" data-collapse="true" data-forms='["#form_layer_position"]'><i class="material-icons">open_with</i><span class="gso_title"><?php _e('Size & Pos', 'revslider');?></span></div><!--
			--><div id="gst_layer_6" data-select="#gst_layer_6" data-unselect=".layer_submodule_trigger" class="layer_submodule_trigger opensettingstrigger" data-collapse="true" data-forms='["#form_layer_advstyle"]'><i class="material-icons">invert_colors</i><span class="gso_title"><?php _e('Adv. Style', 'revslider');?></span></div><!--
			--><div id="gst_layer_4" data-select="#gst_layer_4" data-unselect=".layer_submodule_trigger" class="layer_submodule_trigger opensettingstrigger" data-collapse="true" data-forms='["#form_layer_animation"]'><i class="material-icons">play_arrow</i><span class="gso_title"><?php _e('Animation', 'revslider');?></span></div><!--
			--><div id="gst_layer_15" data-select="#gst_layer_15" data-unselect=".layer_submodule_trigger" class="layer_submodule_trigger opensettingstrigger" data-collapse="true" data-forms='["#form_layer_loop"]'><i class="material-icons">repeat_one</i><span class="gso_title"><?php _e('Loop Layer', 'revslider');?></span></div><!--
			--><div id="gst_layer_9" data-select="#gst_layer_9" data-unselect=".layer_submodule_trigger" class="layer_submodule_trigger opensettingstrigger" data-collapse="true" data-forms='["#form_layer_hover"]'><i class="material-icons">mouse</i><span class="gso_title"><?php _e('Hover', 'revslider');?></span></div><!--
			--><div id="gst_layer_8" data-select="#gst_layer_8" data-unselect=".layer_submodule_trigger" class="layer_submodule_trigger opensettingstrigger" data-collapse="true" data-forms='["#form_layer_parallax"]'><i class="material-icons">system_update_alt</i><span class="gso_title"><?php _e('On Scroll', 'revslider');?></span></div><!--
			...
			--><div id="gst_layer_13" data-select="#gst_layer_13" data-unselect=".layer_submodule_trigger" class="layer_submodule_trigger opensettingstrigger" data-collapse="true" data-forms='["#form_layer_responsiveness"]'><i class="material-icons">photo_size_select_large</i><span class="gso_title"><?php _e('Responsivity', 'revslider');?></span></div><!--
			--><div id="gst_layer_11" data-select="#gst_layer_11" data-unselect=".layer_submodule_trigger" class="layer_submodule_trigger opensettingstrigger callEvent" data-collapse="true" data-forms='["#form_layer_attributes"]'><i class="material-icons">description</i><span class="gso_title"><?php _e('Attributes', 'revslider');?></span></div><!--
			--><div id="gst_layer_7" data-select="#gst_layer_7" data-unselect=".layer_submodule_trigger" class="layer_submodule_trigger opensettingstrigger callEvent" data-evt="updateCustomCSSLayerInput" data-collapse="true" data-forms='["#form_layer_customcss"]'><i class="material-icons">code</i><span class="gso_title"><?php _e('Custom CSS', 'revslider');?></span></div><!--
			--><div id="gst_layer_14" data-select="#gst_layer_14" data-unselect=".layer_submodule_trigger" class="layer_submodule_trigger opensettingstrigger" data-collapse="true" data-forms='["#form_layer_static"]'><i class="material-icons">album</i><span class="gso_title"><?php _e('Static', 'revslider');?></span></div>
		</div>
	</div>
...
?></select>
			...
			<div id="form_layercontent_content_video" class="form_inner open _shfv_ _shfa_">
				...
				<div class="collapsable">
					...
					<div id="" class="layerbg_html5_settings layerbg_audio_settings layer_bg_settings">
						...
						<!--</div>-->
						<label_a><?php _e('Preload', 'revslider');?></label_a><select id="layer_media_preload" class="layerinput tos2 nosearchbox easyinit" data-r="media.speed" ><option value="auto" selected="selected"><?php _e('auto', 'revslider');?></option><option value="none"><?php _e('Disabled', 'revslider');?></option><option  value="metadata"><?php _e('Meta Data', 'revslider');?></option></select>
						<div class="_shfa_">
							<label_a><?php _e('Skip Preload', 'revslider');?></label_a><select id="layer_media_preload" class="layerinput tos2 nosearchbox easyinit" data-r="media.preloadWait" ><option value="0">0 sec</option><option value="1">1 sec</option><option  value="2">2 sec</option><option  value="3">3 sec</option><option  value="4">4 sec</option><option selected="selected" value="5">5 sec</option><option  value="6">6 sec</option><option  value="7">7 sec</option><option  value="8">8 sec</option><option  value="9">9 sec</option><option  value="10">10 sec</option></select>
						</div>
					</div>
					<div class="_nsfa_">
					...
					<label_a><?php _e('Loop', 'revslider');?></label_a><select id="layer_video_loop" class="layerinput tos2 nosearchbox easyinit" data-r="media.loop" ><option value="none" selected="selected"><?php _e('No Loop', 'revslider');?></option><option value="loop"><?php _e('Loop Media - Pause Slide', 'revslider');?></option><option value="loopandnoslidestop"><?php _e('Loop Media - Do Not Pause Slide', 'revslider');?></option></select>
					<div class="_nsfa_">
			...
			<div id="form_layercontent_content_video_adv" class="form_inner open _shfv_ _shfa_ layerbg_youtube_settings layerbg_vimeo_settings layer_bg_settings">
				...
				<div class="collapsable">
					...
					<longoption><i class="material-icons">skip_next</i><label_a ><?php _e('Next Slide at End', 'revslider');?></label_a><input type="checkbox" class="easyinit layerinput" data-r="media.nextSlideAtEnd"></longoption>
			...
			<div id="form_layerstyle_font" class="form_inner open _shft_">
				...
				<div class="collapsable">
					...
					<row class="directrow __idle__">
						...
						<oneshort><label_icon class="ui_letterspacing"></label_icon><input class="layerinput valueduekeyboard smallinput easyinit" data-numeric="true" data-responsive="true" data-r="idle.letterSpacing.#size#.v" data-min="-100" data-max="100" type="text" id="layer_line_height_idle"></oneshort>
					</row>
