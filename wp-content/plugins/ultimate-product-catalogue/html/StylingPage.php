<?php
	...
	$Product_Comparison_Columns = get_option("UPCP_Product_Comparison_Columns");
	$Product_Comparison_Title_Font_Size = get_option("UPCP_Product_Comparison_Title_Font_Size");
	$Product_Comparison_Title_Font_Color = get_option("UPCP_Product_Comparison_Title_Font_Color");
	$Product_Comparison_Price_Font_Size = get_option("UPCP_Product_Comparison_Price_Font_Size");
	$Product_Comparison_Price_Font_Color = get_option("UPCP_Product_Comparison_Price_Font_Color");
	$Product_Comparison_Price_Background_Color = get_option("UPCP_Product_Comparison_Price_Background_Color");
	...
	$Breadcrumbs_Font_Color = get_option("UPCP_Breadcrumbs_Font_Color");
	$Breadcrumbs_Font_Hover_Color = get_option("UPCP_Breadcrumbs_Font_Hover_Color");
	$Breadcrumbs_Font_Size = get_option("UPCP_Breadcrumbs_Font_Size");
	$Breadcrumbs_Font_Family = get_option("UPCP_Breadcrumbs_Font_Family");
...
<div id='Cata' class='upcp-styling-set<?php echo ( ( $Display_Tab == '' or $Display_Tab == 'Cata' ) ? '' : ' upcp-hidden' ); ?>' style='min-height: auto;'>
	<h2 id="catalogue-skin-styling" class="upcp-options-tab-title">Catalog Skin Styling</h2>
				...
				<div class="ewd-upcp-admin-styling-subsection-content-each">
					...
					<div class="ewd-upcp-admin-styling-subsection-content-right">
						<div class="ewd-upcp-admin-styling-subsection-content-color-picker">
							...
							<input type='text' class='ewd-upcp-spectrum' name='sale_button_background_color' value='<?php echo $Sale_Button_Background_Color; ?>' <?php if ($Full_Version != "Yes") {echo "disabled";} ?> />
						</div>
					</div>
				</div>
				<div class="ewd-upcp-admin-styling-subsection-content-each">
					...
					<div class="ewd-upcp-admin-styling-subsection-content-right">
						<div class="ewd-upcp-admin-styling-subsection-content-color-picker">
							<div class="ewd-upcp-admin-styling-subsection-content-color-picker-label"></div>
							<input type='text' class='ewd-upcp-spectrum' name='sale_button_text_color' value='<?php echo $Sale_Button_Text_Color; ?>' <?php if ($Full_Version != "Yes") {echo "disabled";} ?> />
						</div>
					</div>
				</div>
				<div class="ewd-upcp-admin-styling-subsection-content-each">
			...
			<div class="ewd-upcp-admin-styling-subsection-content">
				<div class="ewd-upcp-admin-styling-subsection-content-each">
					<fieldset class="ewdAdminIconChoice">
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='a' <?php if ($Details_Icon_Font_Selection == "a") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>a</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='b' <?php if ($Details_Icon_Font_Selection == "b") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>b</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='c' <?php if ($Details_Icon_Font_Selection == "c") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>c</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='d' <?php if ($Details_Icon_Font_Selection == "d") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>d</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='e' <?php if ($Details_Icon_Font_Selection == "e") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>e</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='f' <?php if ($Details_Icon_Font_Selection == "f") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>f</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='g' <?php if ($Details_Icon_Font_Selection == "g") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>g</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='h' <?php if ($Details_Icon_Font_Selection == "h") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>h</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='i' <?php if ($Details_Icon_Font_Selection == "i") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>i</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='j' <?php if ($Details_Icon_Font_Selection == "j") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>j</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='k' <?php if ($Details_Icon_Font_Selection == "k") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>k</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='l' <?php if ($Details_Icon_Font_Selection == "l") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>l</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='m' <?php if ($Details_Icon_Font_Selection == "m") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>m</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='n' <?php if ($Details_Icon_Font_Selection == "n") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>n</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='o' <?php if ($Details_Icon_Font_Selection == "o") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>o</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='p' <?php if ($Details_Icon_Font_Selection == "p") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>p</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='q' <?php if ($Details_Icon_Font_Selection == "q") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>q</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='r' <?php if ($Details_Icon_Font_Selection == "r") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>r</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='s' <?php if ($Details_Icon_Font_Selection == "s") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>s</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='t' <?php if ($Details_Icon_Font_Selection == "t") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>t</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='u' <?php if ($Details_Icon_Font_Selection == "u") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>u</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='v' <?php if ($Details_Icon_Font_Selection == "v") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>v</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='w' <?php if ($Details_Icon_Font_Selection == "w") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>w</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='x' <?php if ($Details_Icon_Font_Selection == "x") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>x</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='y' <?php if ($Details_Icon_Font_Selection == "y") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>y</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='z' <?php if ($Details_Icon_Font_Selection == "z") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>z</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='A' <?php if ($Details_Icon_Font_Selection == "A") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>A</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='B' <?php if ($Details_Icon_Font_Selection == "B") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>B</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='C' <?php if ($Details_Icon_Font_Selection == "C") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>C</span></label>
						<label class='ewd-upcp-admin-input-container'><input type='radio' class='upcp-font-selector' name='details_icon_font_selection' value='D' <?php if ($Details_Icon_Font_Selection == "D") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span class='upcp-details-icon'>D</span></label>
			...
			<div class="ewd-upcp-admin-styling-subsection-content">
				<div class="ewd-upcp-admin-styling-subsection-content-each">
					...
					<div class="ewd-upcp-admin-styling-subsection-content-right">
						<div class="ewd-upcp-admin-styling-subsection-content-color-picker">
							<div class="ewd-upcp-admin-styling-subsection-content-color-picker-label"></div>
							<input type='text' class='ewd-upcp-spectrum' name='details_icon_color' value='<?php echo $Details_Icon_Color; ?>' <?php if ($Full_Version != "Yes") {echo "disabled";} ?> />
						</div>
					</div>
				</div>
				<div class="ewd-upcp-admin-styling-subsection-content-each">
			...
			<div class="ewd-upcp-admin-styling-subsection-content">
				...
				<div class="ewd-upcp-admin-styling-subsection-content-each">
					...
					<div class="ewd-upcp-admin-styling-subsection-content-right">
						<div class="ewd-upcp-admin-styling-subsection-content-color-picker">
							<div class="ewd-upcp-admin-styling-subsection-content-color-picker-label"></div>
							<input type='text' class='ewd-upcp-spectrum' name='product_comparison_title_font_color' value='<?php echo $Product_Comparison_Title_Font_Color; ?>' <?php if ($Full_Version != "Yes") {echo "disabled";} ?> />
						</div>
					</div>
				</div>
			</div>
...
<div id='Thumbnail' class='upcp-styling-set<?php echo ( $Display_Tab == 'Thumbnail' ? '' : ' upcp-hidden' ); ?>'>
	<h2 id="thumbnail-view-styling" class="upcp-options-tab-title">Thumbnail View Styling</h2>
			...
			<div class="ewd-upcp-admin-styling-subsection-content">
				...
				<div class="ewd-upcp-admin-styling-subsection-content-each">
					...
					<div class="ewd-upcp-admin-styling-subsection-content-right">
						<div class="ewd-upcp-admin-styling-subsection-content-color-picker">
							<div class="ewd-upcp-admin-styling-subsection-content-color-picker-label"></div>
							<input type='text' class='ewd-upcp-spectrum' name='thumbnail_view_image_border_color' value='<?php echo $Thumbnail_View_Image_Border_Color; ?>' <?php if ($Full_Version != "Yes") {echo "disabled";} ?> />
						</div>
					</div>
				</div>
			</div>
			...
			<div class="ewd-upcp-admin-styling-subsection-content">
				...
				<div class="ewd-upcp-admin-styling-subsection-content-each">
					...
					<div class="ewd-upcp-admin-styling-subsection-content-right">
						<div class="ewd-upcp-admin-styling-subsection-content-color-picker">
							<div class="ewd-upcp-admin-styling-subsection-content-color-picker-label"></div>
							<input type='text' class='ewd-upcp-spectrum' name='thumbnail_view_border_color' value='<?php echo $Thumbnail_View_Border_Color; ?>' <?php if ($Full_Version != "Yes") {echo "disabled";} ?> />
						</div>
					</div>
				</div>
			</div>
...
<div id='List' class='upcp-styling-set<?php echo ( $Display_Tab == 'List' ? '' : ' upcp-hidden' ); ?>'>
	<h2 id="list-view-styling" class="upcp-options-tab-title">List View Styling</h2>
			...
			<div class="ewd-upcp-admin-styling-subsection-content">
				...
				<div class="ewd-upcp-admin-styling-subsection-content-each">
					...
					<div class="ewd-upcp-admin-styling-subsection-content-right">
						<div class="ewd-upcp-admin-styling-subsection-content-color-picker">
							<div class="ewd-upcp-admin-styling-subsection-content-color-picker-label"></div>
							<input type='text' class='ewd-upcp-spectrum' name='list_view_image_border_color' value='<?php echo $List_View_Image_Border_Color; ?>' <?php if ($Full_Version != "Yes") {echo "disabled";} ?> />
						</div>
					</div>
				</div>
			</div>
			...
			<div class="ewd-upcp-admin-styling-subsection-content">
				...
				<div class="ewd-upcp-admin-styling-subsection-content-each">
					...
					<div class="ewd-upcp-admin-styling-subsection-content-right">
						<div class="ewd-upcp-admin-styling-subsection-content-color-picker">
							<div class="ewd-upcp-admin-styling-subsection-content-color-picker-label"></div>
							<input type='text' class='ewd-upcp-spectrum' name='list_view_item_color' value='<?php echo $List_View_Item_Color; ?>' <?php if ($Full_Version != "Yes") {echo "disabled";} ?> />
						</div>
					</div>
				</div>
			</div>
...
<div id='Detail' class='upcp-styling-set<?php echo ( $Display_Tab == 'Detail' ? '' : ' upcp-hidden' ); ?>'>
	<h2 id="detail-view-styling" class="upcp-options-tab-title">Detail View Styling</h2>
			...
			<div class="ewd-upcp-admin-styling-subsection-content">
				...
				<div class="ewd-upcp-admin-styling-subsection-content-each">
					...
					<div class="ewd-upcp-admin-styling-subsection-content-right">
						<div class="ewd-upcp-admin-styling-subsection-content-color-picker">
							<div class="ewd-upcp-admin-styling-subsection-content-color-picker-label"></div>
							<input type='text' class='ewd-upcp-spectrum' name='detail_view_image_border_color' value='<?php echo $Detail_View_Image_Border_Color; ?>' <?php if ($Full_Version != "Yes") {echo "disabled";} ?> />
						</div>
					</div>
				</div>
			</div>
...
<div id='Sidebar' class='upcp-styling-set<?php echo ( $Display_Tab == 'Sidebar' ? '' : ' upcp-hidden' ); ?>'>
	<h2 id="sidebar-view-styling" class="upcp-options-tab-title">Sidebar Styling</h2>
			...
			<div class="ewd-upcp-admin-styling-subsection-content">
				...
				<div class="ewd-upcp-admin-styling-subsection-content-each">
					...
					<div class="ewd-upcp-admin-styling-subsection-content-right">
						<div class="ewd-upcp-admin-styling-subsection-content-color-picker">
							<div class="ewd-upcp-admin-styling-subsection-content-color-picker-label"></div>
							<input type='text' class='ewd-upcp-spectrum' name='sidebar_header_color' value='<?php echo $Sidebar_Header_Color; ?>' <?php if ($Full_Version != "Yes") {echo "disabled";} ?> />
						</div>
					</div>
				</div>
			</div>
			...
			<div class="ewd-upcp-admin-styling-subsection-content">
				...
				<div class="ewd-upcp-admin-styling-subsection-content-each">
					...
					<div class="ewd-upcp-admin-styling-subsection-content-right">
						<div class="ewd-upcp-admin-styling-subsection-content-color-picker">
							<div class="ewd-upcp-admin-styling-subsection-content-color-picker-label"></div>
							<input type='text' class='ewd-upcp-spectrum' name='sidebar_subheader_color' value='<?php echo $Sidebar_Subheader_Color; ?>' <?php if ($Full_Version != "Yes") {echo "disabled";} ?> />
						</div>
					</div>
				</div>
			</div>
			...
			<div class="ewd-upcp-admin-styling-subsection-content">
				...
				<div class="ewd-upcp-admin-styling-subsection-content-each">
					...
					<div class="ewd-upcp-admin-styling-subsection-content-right">
						<div class="ewd-upcp-admin-styling-subsection-content-color-picker">
							<div class="ewd-upcp-admin-styling-subsection-content-color-picker-label"></div>
							<input type='text' class='ewd-upcp-spectrum' name='sidebar_checkbox_color' value='<?php echo $Sidebar_Checkbox_Color; ?>' <?php if ($Full_Version != "Yes") {echo "disabled";} ?> />
						</div>
					</div>
				</div>
			</div>
...
<div id='Pagination' class='upcp-styling-set<?php echo ( $Display_Tab == 'Pagination' ? '' : ' upcp-hidden' ); ?>'>
	<h2 id="pagination-view-styling" class="upcp-options-tab-title">Pagination Styling</h2>
...
<div id='Custom-PP' class='upcp-styling-set<?php echo ( $Display_Tab == 'Custom-PP' ? '' : ' upcp-hidden' ); ?>'>
	<h2 id="custom-pp-styling" class="upcp-options-tab-title">Custom Product Page Styling</h2>
