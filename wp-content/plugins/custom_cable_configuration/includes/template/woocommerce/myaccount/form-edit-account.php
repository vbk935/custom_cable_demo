...
$company_website = get_user_meta($user_id, 'billing_company_website', true);
//print_r($_POST); 
?>
<div class="form-EditAccountOuter">
    <form class="woocommerce-EditAccountForm edit-account" action="" method="post" enctype="multipart/form-data">
        ...
        <!-- <p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
            ...
            <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="billing_title" id="account_billing_title" value="<?php //echo esc_attr($title); ?>" />
        </p> -->
        <p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
        ...
        <p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
            ...
            <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="billing_phone" id="account_billing_phone" value="<?php echo esc_attr($phone_number); ?>" />
        </p>
        
        <!-- <p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
            <label for="account_billing_company"><?php //_e('Company', 'woocommerce'); ?> <span class="required">*</span></label>
            <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="billing_company" id="account_billing_company" value="<?php //echo esc_attr($company); ?>" />
        </p>
        
        <p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
            <label for="account_billing_company_website"><?php //_e('Company Website', 'woocommerce'); ?> <span class="required">*</span></label>
            <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="billing_company_website" id="account_billing_company_website" value="<?php //echo esc_attr($company_website); ?>" />
        </p> -->
