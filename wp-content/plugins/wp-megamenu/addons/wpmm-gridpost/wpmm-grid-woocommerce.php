        ...
        if( ! empty($instance['show_cat']) && $instance['show_cat'] == 'on' ){
                ...
                foreach ( $instance['category'] as $value ) {
                    ...
                    if( $data->have_posts()){
                        ...
                        if( $instance['show_nav'] == 'on' ){
                            $output .= '<span data-count="'.esc_attr($count).'" data-count="'.esc_attr($count).'" data-showcat="'.$instance['show_category'].'" data-type="woocommerce" data-category="'.$value.'" data-current="1" data-oderby="'.$instance["order_by"].'" data-column="'.$no_column.'"  data-total="'.$data->max_num_pages.'" class="dashicons dashicons-arrow-left-alt2 wpmm-left wpmm-gridcontrol-left disablebtn"></span>';
                            $var = ($data->max_num_pages == 1)? 'disablebtn' : '';
                            $output .= '<span data-count="'.esc_attr($count).'" data-count="'.esc_attr($count).'" data-showcat="'.$instance['show_category'].'" data-type="woocommerce" data-category="'.$value.'"  data-current="1" data-oderby="'.$instance["order_by"].'" data-column="'.$no_column.'"  data-total="'.$data->max_num_pages.'" class="dashicons dashicons-arrow-right-alt2 wpmm-right wpmm-gridcontrol-right '.$var.'"></span>';
                        }
                    }
                    $output .='</div>';
                    $i++;
            ...
            if( $data->have_posts()){
                ...
                if( ! empty($instance['show_nav']) && $instance['show_nav'] == 'on' ){
                    ...
                    $output .= '<span data-count="'.esc_attr($count).'" data-showcat="'.$instance['show_category'].'" data-type="woocommerce" data-category="'.implode(',',$instance['category']).'" data-current="1" data-oderby="'.$instance["order_by"].'" data-column="'.$no_column.'"  data-total="'.$data->max_num_pages.'" class="dashicons dashicons-arrow-left-alt2 wpmm-left wpmm-gridcontrol-left disablebtn"></span>';

                    $var = ($data->max_num_pages == 1)? 'disablebtn' : '';

                    $output .= '<span data-count="'.esc_attr($count).'" data-showcat="'.$instance['show_category'].'" data-type="woocommerce" data-category="'.implode(',',$instance['category']).'"  data-current="1" data-oderby="'.$instance["order_by"].'" data-column="'.$no_column.'"  data-total="'.$data->max_num_pages.'" class="dashicons dashicons-arrow-right-alt2 wpmm-right wpmm-gridcontrol-right '.$var.'"></span>';
                }
            }
        }
