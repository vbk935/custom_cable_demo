...
function fmt_admin_notice(){
	...
	if( get_transient( 'fmt-admin-notice' ) ){
		...
		<div class="updated notice is-dismissible">
			<p><a href="https://wpgoplugins.com/plugins/seo-media-manager/" target="_blank"><strong>Format Media Titles PRO</strong></a> is now available! Access great new features such as the batch processor to actively reformat all existing media. <b>Try risk free today with our 100% money back guarantee! <span class="dashicons dashicons-smiley"></span></b></p>
		</div>
		<?php
...
function fmt_plugin_action_links( $links, $file ) {
	...
	//if ( $file == plugin_basename( __FILE__ ) ) {
		...
		//$links[] = '<a style="color:green;" href="https://wpgoplugins.com/plugins/seo-media-manager/" target="_blank" title="Upgrade to the Pro version - 100% money back guarantee"><span class="dashicons dashicons-awards"></span></a>';
	//}
...
function fmt_plugin_settings_link( $links, $file ) {
	...
	if ( $file == plugin_basename( __FILE__ ) ) {
		$plugin_links = '<a style="color:#60a559;" href="https://wpgoplugins.com/plugins/seo-media-manager/" target="_blank" title="Upgrade for more features"><b>Upgrade</b></a>';
