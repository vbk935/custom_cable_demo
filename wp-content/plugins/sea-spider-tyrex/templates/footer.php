	...
	<footer id="footer" role="contentinfo" class="footer-main">
		<div class="container-fluid">
			<div class="row">
                      ...
                      <div class="layout-cell">
                        <div style="margin-left:auto;margin-right:auto;">
                                <?php if( get_field('website_main', 'option') ){ ?><a href="<?php the_field('website_main', 'option'); ?>"><?php } ?>
                                    ...
                                    if( !empty($image) ): ?>
                                        <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>"  class="img-responsive col-md-12"/>
                                    <?php endif; ?>
                                ...
                                <div class="privacy">
                                    ...
                                    <p class="script not-tyr family"><a href="http://www.tyrexmfg.com/" target="_blank">A TyRex Technology Family Company</a></p>
                                    <?php if( get_field('privacy_page', 'option')  OR  get_field('terms_of_service', 'option')){ ?><p><?php } ?>
                                        <?php if( get_field('privacy_page', 'option') ){ ?><a href="https://www.megladonmfg.com/privacy-policy/">Privacy Policy</a><?php } ?>
                                        <?php if( get_field('privacy_page', 'option')  &&  get_field('terms_of_service', 'option')){ ?><span>|</span><?php } ?>
                                        <?php if( get_field('terms_of_service', 'option') ){ ?><a href="https://www.megladonmfg.com/terms-of-service/">Terms of Service</a> <?php } ?>
                                    <?php if( get_field('privacy_page', 'option')  OR  get_field('terms_of_service', 'option')){ ?></p><?php } ?>
                                </div>
                            </div>
                        </div>
				...
				<?php /*?><div class="col-md-3 col-md-push-6 hidden-sm hidden-xs">
...
<table class="logo-table"><tbody><tr><td align="center" valign="middle">
  <div class="table-div">
				...
				<div class="links col-md-6">
					...
					<?php if( get_field('subscribe', 'option')){ ?><div class="social-block clearfix"><?php } else { echo "<div class='soc-med clearfix'>"; } ?>
				...
				<div class="col-md-3">
                <img src="https://shop.megladonmfg.com/wp-content/uploads/graphic-iso-accreditation.png" style="
    height: 177px;
">
...
<div class="container">
	<div class="legal"> <a href="https://www.megladonmfg.com/copyright-trademark-notice/">Copyright &copy;
		<?php $date = date("Y"); ?>
