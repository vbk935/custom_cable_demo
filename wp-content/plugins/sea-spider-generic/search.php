...
add_filter( 'get_search_form', 'ssg_search_form' );
...
//					DEPLOYMENT
//
//					get_search_form('ssg_search_form'); 				
//
//*****************************************************************************
...
//
//*****************************************************************************
function ssg_search_filter($query) {
...
add_filter('pre_get_posts','ssg_search_filter');
